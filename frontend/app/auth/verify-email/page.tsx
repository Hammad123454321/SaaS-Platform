      ...
      <div className="glass w-full max-w-md rounded-2xl p-8 shadow-2xl text-center">
        {status === "pending" && !token && (
          <>
            ...
            <div className="space-y-3">
              ...
              <Link
                href="/login"
                className="block w-full rounded-lg border border-white/10 bg-white/5 px-4 py-2 text-sm font-medium text-white transition hover:bg-white/10"
              >
                Back to Login
              </Link>
            </div>
        ...
        {status === "verifying" && (
          <div className="mb-6 space-y-2">
            ...
            <h1 className="text-2xl font-semibold text-white">Verifying...</h1>
            <p className="text-sm text-gray-200/80">Please wait while we verify your email.</p>
          </div>
        )}
        ...
        {status === "success" && (
          <div className="mb-6 space-y-2">
            ...
            <p className="mt-2 text-xs text-gray-300/80">Redirecting to login...</p>
          </div>
        )}
