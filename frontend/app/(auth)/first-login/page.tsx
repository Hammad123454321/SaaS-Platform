    ...
    <div className="flex min-h-[80vh] items-center justify-center p-4">
      <div className="glass w-full max-w-md rounded-2xl p-8 shadow-2xl">
        <div className="mb-6 space-y-2 text-center">
          <p className="text-sm uppercase tracking-[0.2em] text-cyan-200">First Login</p>
        ...
        {loadingPolicies ? (
          <div className="text-center text-gray-200/80">Loading policies...</div>
        ) : (
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="text-sm text-gray-200/80">Confirm Password</label>
              <input
                className="mt-1 w-full rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-white placeholder:text-gray-400 outline-none focus:border-cyan-400"
                type="password"
            ...
            {hrPolicies.length > 0 && (
              <div className="space-y-3 rounded-lg border border-white/10 bg-white/5 p-4">
                <p className="text-sm font-medium text-white">HR Policies</p>
                <p className="text-xs text-gray-300/80">Please acknowledge the following HR policies:</p>
                {hrPolicies.map((policy) => (
                  <div key={policy.id} className="space-y-2">
                    ...
                    <div className="ml-6 max-h-32 overflow-y-auto rounded border border-white/5 bg-white/5 p-2 text-xs text-gray-300/80">
                      {policy.content}
                    </div>
                  </div>
                ))}
